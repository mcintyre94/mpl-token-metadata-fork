...
pub const PRINT_V2_DISCRIMINATOR: u8 = 55;
...
pub struct PrintV2 {
    ...
    pub edition_mint: (solana_pubkey::Pubkey, bool),
    ...
    pub holder_delegate_record: Option<solana_pubkey::Pubkey>,
    /// The authority printing the edition for a delegated print
    pub delegate: Option<solana_pubkey::Pubkey>,
}

impl PrintV2 {
    pub fn instruction(&self, args: PrintV2InstructionArgs) -> solana_instruction::Instruction {
...
impl Default for PrintV2InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct PrintV2Builder {
    ...
    edition_mint: Option<(solana_pubkey::Pubkey, bool)>,
    ...
    holder_delegate_record: Option<solana_pubkey::Pubkey>,
...
impl PrintV2Builder {
    ...
    pub fn edition_mint(
        &mut self,
        edition_mint: solana_pubkey::Pubkey,
        as_signer: bool,
    ) -> &mut Self {
    ...
    /// The authority printing the edition for a delegated print
    #[inline(always)]
    pub fn delegate(&mut self, delegate: Option<solana_pubkey::Pubkey>) -> &mut Self {
...
pub struct PrintV2CpiAccounts<'a, 'b> {
    ...
    /// Mint of new token - THIS WILL TRANSFER AUTHORITY AWAY FROM THIS KEY
    pub edition_mint: (&'b solana_account_info::AccountInfo<'a>, bool),
    /// Owner of the token account of new token
    ...
    /// The Delegate Record authorizing escrowless edition printing
    pub holder_delegate_record: Option<&'b solana_account_info::AccountInfo<'a>>,
    /// The authority printing the edition for a delegated print
...
impl<'a, 'b> PrintV2CpiBuilder<'a, 'b> {
    ...
    pub fn holder_delegate_record(
        &mut self,
        holder_delegate_record: Option<&'b solana_account_info::AccountInfo<'a>>,
    ) -> &mut Self {
...
struct PrintV2CpiBuilderInstruction<'a, 'b> {
    ...
    edition_mint: Option<(&'b solana_account_info::AccountInfo<'a>, bool)>,
