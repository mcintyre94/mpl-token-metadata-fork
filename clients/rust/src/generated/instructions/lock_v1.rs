...
pub const LOCK_V1_DISCRIMINATOR: u8 = 46;
...
impl LockV1 {
    pub fn instruction(&self, args: LockV1InstructionArgs) -> solana_instruction::Instruction {
...
impl Default for LockV1InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
