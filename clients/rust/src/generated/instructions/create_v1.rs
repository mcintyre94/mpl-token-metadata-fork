...
pub const CREATE_V1_DISCRIMINATOR: u8 = 42;
...
pub struct CreateV1 {
    ...
    /// Mint of token asset
    pub mint: (solana_pubkey::Pubkey, bool),
    /// Mint authority
...
pub struct CreateV1Builder {
    ...
    mint: Option<(solana_pubkey::Pubkey, bool)>,
...
impl CreateV1Builder {
    ...
    /// Mint of token asset
    #[inline(always)]
    pub fn mint(&mut self, mint: solana_pubkey::Pubkey, as_signer: bool) -> &mut Self {
...
pub struct CreateV1CpiAccounts<'a, 'b> {
    ...
    /// Mint of token asset
    pub mint: (&'b solana_account_info::AccountInfo<'a>, bool),
    /// Mint authority
...
struct CreateV1CpiBuilderInstruction<'a, 'b> {
    ...
    master_edition: Option<&'b solana_account_info::AccountInfo<'a>>,
    mint: Option<(&'b solana_account_info::AccountInfo<'a>, bool)>,
