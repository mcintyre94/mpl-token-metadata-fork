...
pub const MINT_V1_DISCRIMINATOR: u8 = 43;
...
impl MintV1 {
    pub fn instruction(&self, args: MintV1InstructionArgs) -> solana_instruction::Instruction {
...
impl Default for MintV1InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
