...
pub const PRINT_V1_DISCRIMINATOR: u8 = 55;
...
impl PrintV1 {
    pub fn instruction(&self, args: PrintV1InstructionArgs) -> solana_instruction::Instruction {
...
impl Default for PrintV1InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct PrintV1Builder {
    ...
    master_token_account_owner: Option<solana_pubkey::Pubkey>,
...
pub struct PrintV1CpiAccounts<'a, 'b> {
    ...
    /// owner of token account containing master token
    pub master_token_account_owner: &'b solana_account_info::AccountInfo<'a>,
    /// token account containing token from master metadata mint
...
struct PrintV1CpiBuilderInstruction<'a, 'b> {
    ...
    master_token_account_owner: Option<&'b solana_account_info::AccountInfo<'a>>,
