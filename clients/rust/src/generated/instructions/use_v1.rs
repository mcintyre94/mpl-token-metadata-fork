...
pub const USE_V1_DISCRIMINATOR: u8 = 51;
...
impl UseV1 {
    pub fn instruction(&self, args: UseV1InstructionArgs) -> solana_instruction::Instruction {
...
impl Default for UseV1InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
